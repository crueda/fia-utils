...
if (len(sys.argv) < 5):
    print '$> show_rssi.sh caja stadistics_file fecha_inicial fecha_final'
    print 'EJEMPLO: $> ./show_rssi.sh 002 ../logs/Stadistics.log 2014-01-1508:15:00 2014-01-1508:17:10'
    exit()
