...
if (len(sys.argv) < 5):
    print '$> show_satellites.sh caja stadistics_file fecha_inicial fecha_final'
    print 'EJEMPLO: $> ./show_satellites.sh 002 ../logs/Stadistics.log 2014-01-1508:15:00 2014-01-1508:17:10'
    exit()
					...
					if line.find('PRAVE')>0 :
						...
						if (index_separador>-1):
							...
							if box_number == str_box:                        
								...
								print hora_llegada + " -> " + satelites_raveon + ' (fix: ' + fix_raveon + ')'
		except:
			pass
	except:
		pass
